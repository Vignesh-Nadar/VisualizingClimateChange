...
DAT.Globe = function (container) {
  ...
  var rotation = { x: 0, y: 0 },
    target = { x: Math.PI * 1, y: Math.PI / 4.5 },
  ...
  function init() {
    ...
    uniforms['texture'].value = THREE.ImageUtils.loadTexture('BM.jpeg');
    ...
    var urls = ['backgroundspace.jpg', 'backgroundspace.jpg', 'backgroundspace.jpg', 'backgroundspace.jpg', 'backgroundspace.jpg', 'backgroundspace.jpg'];
  ...
  addData = function (data, opts) {
    ...
    opts.format = opts.format || 'magnitude'; //default is always magnitude but library allows for Legend
  ...
  function removeObject(scene, object) {
    ...
    if (object instanceof THREE.Mesh) {
      //renderer.removeObject( scene, object );
